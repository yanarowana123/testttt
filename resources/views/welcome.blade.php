            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        <form action="/contact" method="POST" class="w-64 mx-auto" x-data="form()"
                              @submit.prevent="submitData">
                            <div class="m-2">
                                <label class="block mb-2">Url:</label>
                                <input type="text" name="origin_url" class="border w-full p-1"
    ...
    function form() {
        return {
            ...
            async submitData() {
                ...
                if (response.ok) {
                    this.short_url = data.data.short_url
                } else {
                    this.error  = data.errors.origin_url[0]
                }
            }
        }
    }
